...
public class ConstantsStore {
     ...
     */
    public static final String DESERIALIZER_FAIL_MESSAGE = "Could not deserialize request: ";
    public static final String DESERIALIZER_NULL_MESSAGE = "Deserialization returned null";
    public static final String DESERIALIZER_NODE_READ_FAIL_MESSAGE = "Exception while reading value from JsonNode";
    public static final String DESERIALIZER_CODEC_READ_FAIL_MESSAGE = "Exception while reading three by codec";
    public static final String DESERIALIZER_DATETIME_PARSE_FAIL_MESSAGE = "Exception while parsing DateTime";
    public static final String DESERIALIZER_DESERIALIZED_MESSAGE = "deserialized to: ";
    ...
    /**
     * WeahterApiDto deserialization node constants
     */
    ...
    /**
     * ScheduledConfig logs
     */
    public static final String TRANSACTION_FINISHED_LOG = "Scheduled method transaction completed";
    public static final String TRANSACTION_STARTED_LOG = "Scheduled method transaction started";
